...
if app_mode == "🤖 Dashboard":
    ...
    if "Dashboard" in selected_tab:
        ...
        m4 = round(master_df["avg_tenure"].mean() / 12, 1)
...
<div>
<div class="card-value">{m4}<span>Yrs</span></div>
<div class="card-label">Avg Tenure</div>
</div>
</div>
</div>
</div>
                ...
                for i, (_, row) in enumerate(df_to_show.iterrows()):
                    ...
                    with c3:
                        ...
                        <div style="display: flex; align-items: center; gap: 10px; padding: 8px 0;">
                            <div style="font-weight: 800; color: {score_color}; font-size: 14px; width: 60px; white-space: nowrap;">{score:.2f}%</div>
